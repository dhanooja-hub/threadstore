...
from store.models import Product,Size,BasketItem,Basket,Order
...
class AddToCartView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        basket_item_objects=BasketItem.objects.filter(basket_object=basket_obj,product_object=product_obj,size_object=size_obj,is_order_placed=False)
